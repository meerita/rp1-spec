...
description: The form of the fixture corpus published with revision v0.5.1 of protocol version 0.
protocol_version: 0
revision: v0.5.1
normative: false
---
...
| `revision` | string | the specification revision the fixture represents, `v0.5.1` in this corpus |
