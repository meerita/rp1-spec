...
description: What revision v0.5.0 of protocol version 0 defines and does not define, with the requirement levels, version axes, terminology, and limitations of the document set.
protocol_version: 0
revision: v0.5.0
status: draft
order: 1
...
Revision v0.5.0 publishes the documents of this set and the fixture corpus
