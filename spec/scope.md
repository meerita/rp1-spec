...
description: What revision v0.1.2 of protocol version 0 defines and does not define, with the requirement levels, version axes, terminology, and limitations of the document set.
protocol_version: 0
revision: v0.1.2
status: draft
order: 1
...
Revision v0.1.2 publishes the documents of this set and the fixture corpus
