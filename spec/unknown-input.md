...
| 4 | the total length exceeds the maximum frame size | resource limit | connection-fatal | Pre-Negotiation Bounds | `limits/frame-one-byte-past-the-maximum`, `limits/metadata-length-exceeds-the-frame`, `framing/oversize-frame-refused-before-the-body-arrives` |
